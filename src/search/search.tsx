...
> {
    ...
    protected addToFrontier(cell: Cell, parent: Path, isDiagonal: boolean): void {
        ...
        const cost = (parent ? parent.cost : 0) + cell.getPathCost() * (isDiagonal ? sqrt2 : 1);
            ...
            <div className="search">
                <div>
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Switch
                                checked={this.state.gridDistance}
                                onChange={(event, checked) =>
                                    this.setState({gridDistance: checked})
                                }
                                color="primary"
                            />
                        }
                        label="Use grid distance"
                    />
                    <br />
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Switch
                                ...
                                onChange={(event, checked) =>
                                    this.setState({allowDiagonal: checked})
                                }
                                color="primary"
                            />
                        }
                ...
                <div>
                    ...
                    <div className="heuristicWeight">
                        <Slider
                            className="slider"
                            min={0}
                            max={10}
                            scaleLength={1}
                            value={Math.sqrt(this.state.heuristicWeight) * 2}
                            onChange={value =>
                                this.setState({heuristicWeight: (value / 2) * (value / 2)})
                            }
                        />

                        <FormLabel>Heuristic weight: {this.state.heuristicWeight}</FormLabel>
                    </div>
                </div>
                <br style={{clear: "both"}} />
            </div>
